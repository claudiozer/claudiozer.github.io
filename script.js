...
const translations = {
  es: {
    ...
    "profile.title": "Perfil", "profile.nationality": "Argentino", "profile.sports": "CrossFit y Hyrox", "profile.focusLabel": "Enfocado en:", "profile.focus": "Creatividad, tecnología y soluciones que conectan.",
    ...
    "cards.crossfitHyrox": "CrossFit y Hyrox", "cards.crossfitText": "No es solo entrenar el cuerpo, es entrenar la mente para no rendirse.", "cards.viewRoutine": "Ver rutina →",
  ...
  en: {
    ...
    "profile.title": "Profile", "profile.nationality": "Argentinian", "profile.sports": "CrossFit and Hyrox", "profile.focusLabel": "Focused on:", "profile.focus": "Creativity, technology and solutions that connect.",
    ...
    "cards.crossfitHyrox": "CrossFit and Hyrox", "cards.crossfitText": "It is not just about training the body, but training the mind not to give up.", "cards.viewRoutine": "View routine →",
  ...
  pt: {
    ...
    "profile.title": "Perfil", "profile.nationality": "Argentino", "profile.sports": "CrossFit e Hyrox", "profile.focusLabel": "Focado em:", "profile.focus": "Criatividade, tecnologia e soluções que conectam.",
    ...
    "cards.crossfitHyrox": "CrossFit e Hyrox", "cards.crossfitText": "Não é apenas treinar o corpo, é treinar a mente para não desistir.", "cards.viewRoutine": "Ver rotina →",
